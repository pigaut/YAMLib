...
public class ConfigRepresenter extends BaseRepresenter {
    ...
    public ConfigRepresenter(DumpSettings settings) {
        ...
        this.nullRepresenter = new ConfigRepresenter.RepresentNull();
        this.representers.put(String.class, new ConfigRepresenter.RepresentString());
        this.representers.put(Boolean.class, new ConfigRepresenter.RepresentBoolean());
        this.representers.put(Character.class, new ConfigRepresenter.RepresentString());

        this.parentClassRepresenters.put(Number.class, new ConfigRepresenter.RepresentNumber());
        this.parentClassRepresenters.put(List.class, new ConfigRepresenter.RepresentList());
        this.parentClassRepresenters.put(Map.class, new ConfigRepresenter.RepresentMap());
